...
- Uses two on-screen photodiode trigger images for EEG timing:
  one trigger for left-gaze trials and one trigger for right-gaze trials
...
- Trigger side indicates the cued/gazed target side
"""
...
# Two photodiode trigger locations.
    ...
    for trial in block_trials:
        ...
        for frameN in range(total_frames):
            ...
            if USE_PHOTODIODE_PATCH and photodiode_pulse_on:
                draw_photodiodes(active_side=gaze_target_side, trigger_state="on")
            else:
                draw_photodiodes(active_side=None, trigger_state="off")
        ...
        writer.writerow({
            ...
            'photodiode_trigger_side': gaze_target_side,
